...
public class UserDetailsServiceImp implements UserDetailsService {
  ...
  public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    ...
    public UserWithRoles userNotIgnoreCase(String username) {
        UserWithRoles user = userWithRolesRepository.findByUsername(username);
        if(user == null) {
        throw new ResponseStatusException(HttpStatus.UNAUTHORIZED,WRONG_USERNAME_OR_PASSWORD);
        }
        return user;
    }
}
